...
public:
	...
	D3DTexture2D(ID3D11Device *d3dDevice, int width, int height, DXGI_FORMAT format, uint bindFlags, int mipLevels);
	// Construct a Texture2DMS
	D3DTexture2D(ID3D11Device *d3dDevice, int width, int height, DXGI_FORMAT format, uint bindFlags, int mipLevels, const DXGI_SAMPLE_DESC &sampleDesc);
	// Construct a Texture2DArray
	D3DTexture2D(ID3D11Device *d3dDevice, int width, int height, DXGI_FORMAT format, uint bindFlags, int mipLevels, int arraySize);
	// Construct a Texture2DMSArray
	D3DTexture2D(ID3D11Device *d3dDevice, int width, int height, DXGI_FORMAT format, uint bindFlags, int mipLevels, int arraySize, const DXGI_SAMPLE_DESC &sampleDesc);
...
private:
	...
	// Not implemented
	D3DTexture2D(const D3DTexture2D &);
	D3DTexture2D &operator=(const D3DTexture2D &);
};
