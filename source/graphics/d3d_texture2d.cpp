...
D3DTexture2D::D3DTexture2D(ID3D11Device *d3dDevice, int width, int height, DXGI_FORMAT format, uint bindFlags, int mipLevels) {
...
D3DTexture2D::D3DTexture2D(ID3D11Device *d3dDevice, int width, int height, DXGI_FORMAT format, uint bindFlags, int mipLevels, const DXGI_SAMPLE_DESC &sampleDesc) {
...
D3DTexture2D::D3DTexture2D(ID3D11Device *d3dDevice, int width, int height, DXGI_FORMAT format, uint bindFlags, int mipLevels, int arraySize) {
...
D3DTexture2D::D3DTexture2D(ID3D11Device *d3dDevice, int width, int height, DXGI_FORMAT format, uint bindFlags, int mipLevels, int arraySize, const DXGI_SAMPLE_DESC &sampleDesc) {
	// UAV's can't point to multisampled resources
...
void D3DTexture2D::InternalConstructor(ID3D11Device *d3dDevice, int width, int height, DXGI_FORMAT format, UINT bindFlags, int mipLevels, int arraySize, int sampleCount, int sampleQuality, D3D11_RTV_DIMENSION rtvDimension, D3D11_UAV_DIMENSION uavDimension, D3D11_SRV_DIMENSION srvDimension) {
	// Initalize
	mShaderResource = 0;
