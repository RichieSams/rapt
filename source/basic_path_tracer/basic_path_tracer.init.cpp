...
void BasicPathTracer::CreateScene() {
	...
	//CreateNineBallsScene();
	CreateCornellBoxScene();
}

void BasicPathTracer::CreateNineBallsScene() {
	...
	materials[4] = {Scene::MATERIAL_TYPE_DIFFUSE, make_float3(1.0f, 1.0f, 1.0f), make_float3(3.0f, 3.0f, 3.0f)};
	materials[5] = {Scene::MATERIAL_TYPE_SPECULAR, make_float3(0.95f, 0.95f, 0.95f), make_float3(0.0f, 0.0f, 0.0f)};
